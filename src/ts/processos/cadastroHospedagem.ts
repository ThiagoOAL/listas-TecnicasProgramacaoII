...
export default class CadastroHospedagem extends Processo {
    ...
    processar(): void {
        ...
        console.log('Iniciando o cadastro de uma Hospedagem...')

        let documento = this.entrada.receberTexto('Qual o número do documento do cliente a ser registrado como resposável da hospedagem? ')
        ...
        this.opcao = this.entrada.receberNumero('Qual tipo de quarto deseja registrar?')
