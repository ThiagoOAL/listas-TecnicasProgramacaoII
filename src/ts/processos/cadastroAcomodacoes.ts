...
export default class CadastroAcomodacoes extends Processo {
    ...
    processar(): void {
        ...
        this.acomodacoes.push(
            diretorCasalSimples.construir(),
            diretorFamiliaSimples.construir(),
            diretorFamiliaMais.construir(),
            diretorFamiliaSuper.construir(),
            diretorSolteiroSimples.construir(),
            diretorSolteiroMais.construir()
